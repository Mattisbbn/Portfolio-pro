<section id="projets" class="flex h-dvh flex-col items-center justify-center md:w-10/10 mx-auto">
  <h1 class="text-center text-4xl md:text-6xl font-bold mb-6">Projets</h1>


    <div class="swiper h-[10vh] w-full">
      <div class="swiper-wrapper w-full h-[10vh]">

        <div class="pro-project swiper-slide flex justify-center items-center relative w-full h-full">
          <img class=" object-cover rounded-xl" src="/img/projets/ovnyl.jpg" alt="Slide 1">
          <div class="absolute inset-0 flex flex-col items-center justify-center">
            <p class="text-white text-2xl font-bold pb-2 text-shadow">Ovnyl</p>
